############### Learnable channel-wise scale for HF component ###############
...
__all__ = [
    'attnscale_small_24', 'attnscale_small_12',
    'attnscale_base_24', 'attnscale_base_12'
]
...
@register_model
def attnscale_small_12(pretrained=False, **kwargs):
    print("Running AttnScale small 12!!")
...
@register_model
def attnscale_small_24(pretrained=False, **kwargs):
    print("Running AttnScale small 24!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
        embed_dim=384, depth=24, num_heads=6, mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.default_cfg = _cfg()
    if pretrained:
        raise NotImplementedError()
...
@register_model
def attnscale_base_12(pretrained=False, **kwargs):
    print("Running AttnScale base 12!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
...
@register_model
def attnscale_base_24(pretrained=False, **kwargs):
    print("Running AttnScale base 24!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
        embed_dim=768, depth=24, num_heads=12, mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.default_cfg = _cfg()
    if pretrained:
        raise NotImplementedError()
